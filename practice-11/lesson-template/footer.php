<footer class="container min-h-[428px] max-w-[1170px] bg-[#2E2100] pt-[96px] pb-[83px] text-white">
    <div>
      <!-- Main Footer Content -->
      <div class="flex flex-row">
        <!-- Lesson Brand Section -->
        <div class="mr-[145px] flex flex-col">
          <div class="mb-[18px]">
            <h2
              class="flex cursor-pointer flex-row font-[sen] text-[24px] leading-[34px] font-[700] text-white not-italic">
              Lesson <span class="text-[#FFB900]">.</span>
            </h2>
          </div>

          <p class="mb-[18px] w-[267px] font-[poppins] text-[14px] leading-[26px] font-[400] text-[#BFBCB2]">
        ...
        <!-- Company Links -->
        <div class="mr-[137px]">
          <h3 class="mb-[14px] font-[poppins] text-[16px] leading-[28px] font-[600] text-white">
            Company
          </h3>
          <div class="mb-[28px] h-[1px] w-[130px] bg-[#59554B]"></div>

          <ul class="space-y-[12px] font-[poppins] text-[14px] leading-[26px] font-[400] text-[#BFBCB2]">
            <li>
              <a href="#">About Us</a>
            </li>
            <li>
        ...
        <div>
          ...
          <div class="mb-[28px] h-[1px] w-[130px] bg-[#59554B]"></div>
          <div class="space-y-[12px] font-[poppins] text-[14px] leading-[26px] font-[400] text-[#BFBCB2]">
            <div>
              <span class="font-[600] text-white">Location:</span>
              <span>27 Division St, New York, NY 10002, USA</span>
            </div>
            <div>
              <span class="font-[600] text-white">Email:</span>
              <span>email@gmail.com</span>
            </div>
            <div>
              <span class="font-[600] text-white">Phone:</span>
              <span>+ 000 1234 567 890</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Copyright Section -->
      <div class="mt-[38px] mb-[28px] h-[1px] w-[1170px] bg-[#59554B]"></div>
      <p class="text-center font-[poppins] text-[14px] leading-[26px] font-[400] text-[#807D74]">
