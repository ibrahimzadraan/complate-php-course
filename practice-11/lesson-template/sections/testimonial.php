<section class="container flex min-h-[380px] max-w-[1170px] items-center bg-[#2E2100] pt-[124px] pb-[96px]">
    <div class="mx-auto flex flex-row items-center gap-[249px]">
      <!-- Left side - Profile -->
      <div>
        <div class="mb-[18px]">
          <img src="assets/images/testimonial-section/image1.png" />
        </div>

        <h3 class="mb-[4px] font-[sen] text-[24px] leading-[34px] font-[700] text-[#F7F7F7]">
          Peter Moor
        </h3>
        <span class="font-[poppins] text-[14px] leading-[26px] font-[400] text-[#BFBCB2]">
      ...
      <div class="relative flex-1">
        ...
        <p class="relative w-[740px] font-[poppins] text-[26px] leading-[40px] font-[400] text-white italic">
